...
const STORAGE_KEY = 'study-review-theme';
...
function setTheme(theme) {
    if (theme === DARK_THEME) {
        ...
        themeIcon.innerHTML = SUN_ICON; // Sun icon for switching to light
        localStorage.setItem(STORAGE_KEY, DARK_THEME);
    } else {
        document.documentElement.removeAttribute('data-theme');
        themeIcon.innerHTML = MOON_ICON; // Moon icon for switching to dark
